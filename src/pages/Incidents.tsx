...
const Incidents = () => {
  ...
  const KPI = ({ title, value, icon: Icon, color, delay }: any) => (
    <CyberCard glowColor={color} delay={delay} className="p-6">
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <KPI title="Open Incidents" value={openIncidents} icon={AlertTriangle} color="red" delay={0.1} />
        <KPI title="In Progress" value={inProgressIncidents} icon={Clock} color="blue" delay={0.2} />
        <KPI title="Critical" value={criticalIncidents} icon={XCircle} color="red" delay={0.3} />
        <KPI title="Resolved Today" value={resolvedToday} icon={CheckCircle} color="green" delay={0.4} />
      </div>
